module SwaggerClient
  # 
  class CreditRequest < BaseObject
    attr_accessor :amount, :currency, :reference_id, :vc_order_id, :payment, :bill_to, :ship_to, :payment_solution, :merchant_defined_data, :items, :merchant_descriptor
