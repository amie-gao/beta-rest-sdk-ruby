...
module SwaggerClient
  class RefundsApi
    ...
    def list_capture_refunds(capture_id, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: RefundsApi#list_capture_refunds ..."
      end
      ...
      result = @api_client.call_api(:GET, path,
        ...
        :return_type => 'Array<ListRefundResponse>')
      if Configuration.debugging
        Configuration.logger.debug "API called: RefundsApi#list_capture_refunds. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def refund_capture(id, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: RefundsApi#refund_capture ..."
      end
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'refund_request'])
      ...
      result = @api_client.call_api(:POST, path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'RefundPostResponse')
      if Configuration.debugging
        Configuration.logger.debug "API called: RefundsApi#refund_capture. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def list_refunds(opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: RefundsApi#list_refunds ..."
      end
      ...
      result = @api_client.call_api(:GET, path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ListRefundResponse')
      if Configuration.debugging
        Configuration.logger.debug "API called: RefundsApi#list_refunds. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def get_refund(id, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: RefundsApi#get_refund ..."
      end
      ...
      result = @api_client.call_api(:GET, path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'RefundGetResponse')
      if Configuration.debugging
        Configuration.logger.debug "API called: RefundsApi#get_refund. Result: #{result.inspect}"
      end
      return result
    end
    ...
    # @option opts [Integer] :limit limit
    # @return [Array<ListRefundResponse>]
    def list_sale_refunds(sale_id, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: RefundsApi#list_sale_refunds ..."
      end
      ...
      result = @api_client.call_api(:GET, path,
        ...
        :return_type => 'Array<ListRefundResponse>')
      if Configuration.debugging
        Configuration.logger.debug "API called: RefundsApi#list_sale_refunds. Result: #{result.inspect}"
      end
      return result
    end
    ...
    # @return [RefundPostResponse]
    def refund_sale(id, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: RefundsApi#refund_sale ..."
      end
      ...
      result = @api_client.call_api(:POST, path,
        ...
        :return_type => 'RefundPostResponse')
      if Configuration.debugging
        Configuration.logger.debug "API called: RefundsApi#refund_sale. Result: #{result.inspect}"
      end
      return result
    end
  end
