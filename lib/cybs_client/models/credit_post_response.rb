module CybsClient
  # 
  class CreditPostResponse < BaseObject
    attr_accessor :amount, :_links, :merchant_defined_data, :merchant_descriptor, :reference_id, :payment_solution, :bill_to, :vc_order_id, :currency, :payment, :id, :items, :status, :ship_to
