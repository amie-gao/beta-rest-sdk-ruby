module CybsClient
  ...
  class Sale < BaseObject
    attr_accessor :id, :status, :amount, :currency, :auth_code, :reference_id, :ignore_avs, :ignore_bad_cvn, :commerce_indicator, :vc_order_id, :payment_solution, :merchant_defined_data, :merchant_descriptor, :payment, :bill_to, :ship_to, :items
