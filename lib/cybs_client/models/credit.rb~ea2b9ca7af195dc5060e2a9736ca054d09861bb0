module CybsClient
  # 
  class Credit < BaseObject
    attr_accessor :id, :status, :amount, :currency, :reference_id, :vc_order_id, :payment_solution, :merchant_defined_data, :merchant_descriptor, :payment, :bill_to, :ship_to, :items
